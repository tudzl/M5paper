...
void WeatherDisplay::Show()
{
   ...
   canvas.deleteCanvas();
   canvas.createCanvas(960, 540);//ori
   ...
   //DrawGraph(711, 408, 232, 122, "Pressure (hPa)",  0, 7, 800, 1200, myData.weather.forecastPressure); //modified by zell
   DrawGraph(711, 408, 232, 122, title_payload,  0, 7, 800, 1200, myData.weather.forecastPressure); //need test
   //DrawGraph(711, 408, 232, 122, "Pressure (hPa)",  0, 7, 800, 1400, myData.weather.forecastPressure);//ori
   canvas.pushCanvas(0, 0, UPDATE_MODE_GC16);
   delay(1000);
}
